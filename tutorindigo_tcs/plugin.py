...
hooks.Filters.ENV_TEMPLATE_TARGETS.add_items(
    [
        ("tcs-default", "build/openedx/themes"),
        ("tcs-default/env.config.jsx", "plugins/mfe/build/mfe"),
    ],
)
...
hooks.Filters.ENV_PATTERNS_INCLUDE.add_items(
    [
        r"tcs-default/lms/static/sass/partials/lms/theme/",
        r"tcs-default/cms/static/sass/partials/cms/theme/",
    ]
)
...
hooks.Filters.CONFIG_DEFAULTS.add_items(
    [(f"TCS_{key}", value) for key, value in config["defaults"].items()]
)
hooks.Filters.CONFIG_UNIQUE.add_items(
    [(f"TCS_{key}", value) for key, value in config["unique"].items()]
)
hooks.Filters.CONFIG_OVERRIDES.add_items(list(config["overrides"].items()))


#  MFEs that are styled using TCS
tcs_styled_mfes = [
    "learning",
    "learner-dashboard",
    "profile",
...
MFE_CONFIG['TCS_ENABLE_DARK_TOGGLE'] = {{ TCS_ENABLE_DARK_TOGGLE }}
MFE_CONFIG['TCS_FOOTER_NAV_LINKS'] = {{ TCS_FOOTER_NAV_LINKS }}
""",
        ),
        (
